...
describe('Gemini Client (client.ts)', () => {
  ...
  describe('tryCompressChat', () => {
    ...
    it('should not compress across a function call response', async () => {
      ...
      // 1. standard canned user start message
      // 2. compressed summary message
      // 3. standard canned user summary message
      // 4. The last user message (not the last 3 because that would start with a function response)
